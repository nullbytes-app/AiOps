...
def test_pause_processing_success():
    ...
    with patch("admin.utils.operations_core.get_sync_redis_client") as mock_redis_fn:
...
def test_clear_celery_queue_success():
    ...
    with patch("admin.utils.operations_core.celery_app") as mock_celery:
...
def test_sync_tenant_configs_success():
    ...
    with patch("admin.utils.operations_core.get_sync_redis_client") as mock_redis_fn, \
         patch("admin.utils.operations_core.get_db_session") as mock_db_session:
        ...
        mock_config1.servicedesk_url = "https://example.com/servicedesk"
        mock_config1.servicedesk_api_key_encrypted = "secret123encrypted"
        mock_config1.is_active = True

        mock_config2 = MagicMock(spec=TenantConfig)
        mock_config2.tenant_id = "tenant-2"
        mock_config2.servicedesk_url = "https://example2.com/servicedesk"
        mock_config2.servicedesk_api_key_encrypted = "secret456encrypted"
